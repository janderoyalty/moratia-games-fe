				...
				<Col id="about-us--right" sm={12} md={12} lg={7}>
					...
					<div id="about-us---text-box--entry">
						<div className="body-text" id="about-us---text-box--entry--body">
							...
							<p>
								<b>Thomas (CREATOR & CREATIVE DIRECTOR) </b>was born in the
								greater Nashville area of middle Tennessee. From a young age he
								proved himself a creative individual. That creativity would
								guide him to various endeavors ranging from directing video
								projects to working for a time as a professional artist. Now he
								has come full circle to focus on Moratia, a passion project
								started when he was only twelve years old.
							</p>
							<p>
								<b>Jande (GRAPHIC DESIGN & SOFTWARE ENGINEER) </b> was born in
								the country of Liberia and moved to the United States at an
								early age. throughout her years she has worked in a range of
								rolls from video editing to graphic design to software
